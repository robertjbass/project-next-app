           ...
           signUserUp({ commit }) {
             ...
             auth
               ...
               .then((ghUser) => {
                 ...
                 if (isNewUser) {
                   let url =
                     "https://hooks.zapier.com/hooks/catch/6992427/oegd4e1";
                   axios
                     .post(url, userEmail)
                     .then((res) => {
                       console.log(res);
           ...
           createProject({ commit, getters }, payload) {
             ...
             db.collection("projects")
               ...
               .then(() => {
                 ...
                 console.log({path})
                 let urlRef = storage.refFromURL(`gs://project-next-app.appspot.com/${path}`)
                 console.log({urlRef})
                 console.log({imageRef})
                //  console.log({url})
                //  console.log({imageRef});
                ...
                // let downloadUrl
                //  setTimeout(async () => {        
                //    downloadUrl = await urlRef.getDownloadURL()
